      ...
      >
        <div>
          <div className="px-3 py-5 text-center">
            {profilePic ? (
              <img 
                ...
                className="w-[50px] h-[50px] mx-auto rounded-full object-cover border-2 border-[#8D4087]"
              />
            ) : (
              <div className="w-[50px] h-[50px] bg-gray-300 mx-auto rounded-full flex items-center justify-center text-[#8D4087] font-bold text-lg">
          ...
          <ul className="p-4 space-y-5 text-sm text-black font-medium font-sans">
            ...
            <Link to="/available-opportunities" onClick={() => setIsOpen(false)}>
              <li className="bg-white py-2 px-3 rounded-xl hover:bg-gray-300 flex items-center gap-3 m-2">
