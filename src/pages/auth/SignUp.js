    ...
    <div className="flex flex-col lg:flex-row lg:h-screen lg:overflow-hidden bg-white w-full">
      ...
      >
        <div style={{ width: "100%", maxWidth: "360px" }}>
          ...
          <button
            type="button"
            className="w-full flex items-center justify-center gap-3 px-5 py-3 border rounded-xl bg-white hover:bg-gray-50 active:bg-gray-100 transition shadow-sm mb-5"
